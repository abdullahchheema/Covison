...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" updated="June 2026">
      ...
      <p>
        We collect information you provide directly (name, email, company, and project details when
        you book a call, message us on WhatsApp, or email us) and basic analytics data (page views,
        referral sources) to improve our site.
      </p>
      <h2>How we use it</h2>
      <p>
