          ...
          <Reveal>
            <div className="flex max-w-3xl flex-col gap-5">
              <span className="w-fit">
                <Badge variant="accent">Industries</Badge>
              </span>

              <h1 className="text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
                Proven across <span className="text-sheen">verticals</span>.
              </h1>

              <p className="max-w-xl text-lg leading-relaxed text-muted sm:text-xl">
                From dental practices to enterprise teams, we build AI systems that ship and scale
                across more than 20 industries. Here&apos;s where we&apos;ve made the biggest
                impact.
              </p>
